...
<head>
    ...
    <title>Best Online Shoping</title>
 ...
 <div class="navbar navbar-inverse navbar-fixed-top " id="menu">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><img class="logo-custom" src="assets/img/1234.png" alt=""  /></a>
            </div>
       ...
       <div class="home-sec" id="home" style="
    background-image: url('wudil.jpeg');
">
 ...
 <div class="container" >
                ...
                <div class="flexslider set-flexi" id="main-section">
                    <ul class="slides move-me">
                       ...
                       <!--  <li>
                        ...
                        <!-- Slider 03 -->
                        <li>
                            <h3>WELCOME TO FUD-BASED PRODUCT AND SERVICES  </h3>
                           <h1>WHERE YOU CAN BUY HIGH QUALITY GOODS</h1>
                             <a  href="#features-sec" class="btn btn-warning btn-lg" data-toggle="modal" data-target="#ln">
                                SIGN IN
                            </a>
                             <!--<a  href="#features-sec" class="btn btn-success btn-lg" data-toggle="modal" data-target="#su">
                            ...
                            <!-- <a  href="#features-sec" class="btn btn-info btn-lg" data-toggle="modal" data-target="#fp">
                                FORGET PASSWORD
                            </a> -->
							<a  href="#features-sec" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#an">
                                ADMIN
    ...
    <div  class="tag-line" >
        ...
        <h2 data-scroll-reveal="enter from the bottom after 0.1s" ><i class="fa fa-circle-o-notch"></i>Best Online Shoping<i class="fa fa-circle-o-notch"></i> </h2>
                   </div>
               </div>
             </div>
...
<br />
    ...
    <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 " data-scroll-reveal="enter from the bottom after 0.4s">
        ...
        <hr />
                    <div>
                       <!--  <h4>No 2 Opposite fedpoffa,</h4> -->
                        <h4>Federal University Dutse.</h4>
						<h4>Nigeria</h4>
        ...
        <hr />
                    <div >
                        <h4><strong>Call:</strong>  +2348133746479 </h4>
                        <h4><strong>Email: </strong> abdulganiyumustapha2@gmail.com </h4>
                    </div>
                    </div>
                </div>
                 </div>
     ...
     <div class="modal fade" id="su" tabindex="-1" role="dialog" aria-labelledby="myMediulModalLabel">
          <div class="modal-dialog modal-sm">
            <div style="color:white;background-color:#C9725F" class="modal-content">
				 ...
				 <form role="form" method="post" action="register.php">
                   <fieldset>
							...
							<div class="form-group">
                                <input class="form-control" onkeydown="return alphaOnly(event);" placeholder="Firstname" name="ruser_firstname" type="text" required>
							</div>
							
							<div class="form-group">
                                <input class="form-control" onkeydown="return alphaOnly(event);" placeholder="Lastname" name="ruser_lastname" type="text" required>
							</div>
							...
							<div class="form-group">
                                <input class="form-control" maxlength="11" onkeypress="javascript:return isNumber(event)" placeholder="Phone Number" name="user_phone" type="text" required>
              </div>
              <div class="form-group">
...
<!-- Script -->
     ...
     <div class="modal fade" id="ln" tabindex="-1" role="dialog" aria-labelledby="myMediulModalLabel">
          <div class="modal-dialog modal-sm">
            <div style="color:white;background-color:#C9725F" class="modal-content">
              ...
              <div class="modal-body">
				 ...
				 <form role="form" method="post" action="userlogin.php">
                   <fieldset>
                            ...
                            <div class="form-group">
                                <input class="form-control" placeholder="Reg No" name="user_reg" type="" required>
							</div>
              ...
              <div class="modal-footer">
                ...
                <button class="btn btn-md btn-info btn-block" data-toggle="modal" data-target="#fp">Forget Password</button>
        ...
        <!--  -->
             <div class="modal fade" id="fp" tabindex="-1" role="dialog" aria-labelledby="myMediulModalLabel">
          <div class="modal-dialog modal-sm">
            <div style="color:white;background-color:#C9725F" class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 style="color:white" class="modal-title" id="myModalLabel">Forget Password</h4>
              </div>
              <div class="modal-body">
            
        
         <form role="form" method="post" action="forgetpass.php">
                   <fieldset>
              ...
              <div class="modal-footer">
                ...
                <button class="btn btn-md btn-warning btn-block" name="change">Change Password</button>
...
<!-- Script -->
     <!-- CONTACT SECTION END-->
    <div id="footer">
          &copy <?php echo date("Y"); ?> |  <a style="color: #fff" target="_blank">Design by : ABDULGANIYU MUSTAPHA ABAYOMI </a>
    </div>
     <!-- FOOTER SECTION END-->
