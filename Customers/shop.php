...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
         ...
         <center><h3> <span class="glyphicon glyphicon-shopping-cart"></span> This is our Product stocks, Shop now!</h3></center>
        </div>
...
// $query1=mysqli_connect("localhost","root","","db_online");
// mysql_select_db("db_online",$query1);
...
while($query2=mysqli_fetch_array($query))
{
	...
	echo "<div class='col-sm-3'><div class='panel panel-default' style='border-color:#008CBA;'>
            ...
            <center> 
<div style='text-align:center;background-color: white;' class='form-control' rows='1' disabled>".$query2['item_name']."</div>
			</center>
            </div>
           ...
           <a class='fancybox-buttons' href='../Admin/item_images/".$query2['item_image']."' data-fancybox-group='button' title='Page ".$id."- ".$query2['item_name']."'>
					...
					<center><h4> Price: ₦ ".$query2['item_price']." </h4></center>
										...
										<a class='btn btn-block btn-danger' href='add_to_cart.php?cart=".$query2['item_id']."'><span class='glyphicon glyphicon-shopping-cart'></span> Add to cart / Pay now</a>
            </div>
          </div>
        </div>";
