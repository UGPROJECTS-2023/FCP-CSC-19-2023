...
<?php
 ...
 include("config.php");
	...
	{
		$id = $_GET['cart'];
		$stmt_edit = $conn->prepare('SELECT * FROM items WHERE item_id =:item_id');
    ...
    <tr>
        ...
        <a class="btn btn-danger" href="shop.php?id=1"> <span class="glyphicon glyphicon-backward"></span> Cancel </a>
			...
			<div class="alert alert-default" style="background-color:#033c73;">
                       ...
                       &copy 2022 Best Online Shoping| Design by : FOLAMI MICHEAL OYEKANMI and AYANYEMI TIMILEYIN
